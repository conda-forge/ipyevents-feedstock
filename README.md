About ipyevents-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyevents-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=457&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyevents-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyevents` can be installed with `conda`:
...
It is possible to list all of the versions of `ipyevents` available on your platform with `conda`:
...
```
mamba search ipyevents --channel conda-forge
```
...
mamba repoquery search ipyevents --channel conda-forge

# List packages depending on `ipyevents`:
mamba repoquery whoneeds ipyevents --channel conda-forge

# List dependencies of `ipyevents`:
mamba repoquery depends ipyevents --channel conda-forge
```
